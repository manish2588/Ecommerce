...
const Signup = () => {
    ...
    try {
      ...
      if (userCredential.user) {
        await setDoc(doc(db, "Users", userCredential.user.uid), {
          ...
          name: data.name, // Use name from form data
          role: "user",
        });
        ...
        // Delay navigation until toast is shown
        setTimeout(() => {
          toast.success("Sign-up successful!", { position: "top-center" });
          navigate("/login"); // Navigate to login page after the success message
        }, 2000); // Adjust the delay (2000 ms = 2 seconds) to match your preference
      }
  ...
  return (
    ...
    <ToastContainer /> {/* Move ToastContainer outside */}
    <div className="w-full h-full max-w-md p-6 bg-white rounded-lg mb-16">
     <Title text1={'SIGNUP'} text2={'FORM'}/>
      <form onSubmit={handleSubmit(handleSignup)} className="space-y-4 h-full mt-4 ">
        {/* Name Field */}
        <div>
